...
assert_contains "${out}" '0.2.4' 'version outputs 0.2.4'
...
out=$(installed_test)
assert_contains "${out}" '0.2.4' 'installed layout: version works'
...
assert_contains "${out}" '0.2.4' 'proxyctl version reports 0.2.4'
...
out=$(run_proxyctl version)
assert_contains "${out}" '0.2.4' 'entry point passes bash version check'
